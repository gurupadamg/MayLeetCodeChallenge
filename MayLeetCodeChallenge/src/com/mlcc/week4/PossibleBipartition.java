...
public class PossibleBipartition {
	 ...
	 * Constraints:
	 * 
	 * 1 <= N <= 2000 0 <= dislikes.length <= 10000 dislikes[i].length == 2 1 <=
	 * dislikes[i][j] <= N dislikes[i][0] < dislikes[i][1] There does not exist i !=
	 * j for which dislikes[i] == dislikes[j].
	 * 
	 */
	...
	public static void main(String[] args) {
		System.out.println("Test Case1: " + possibleBipartition(4, new int[][] {{1,2},{1,3},{2,4}}));
	}
}
