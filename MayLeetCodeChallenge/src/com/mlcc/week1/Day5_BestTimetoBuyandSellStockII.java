...
public class Day5_BestTimetoBuyandSellStockII {
	...
	public static void main(String[] args) {
		System.out.println("Test Case 1 : " + maxProfit(new int[] { 7, 1, 5, 3, 6, 4 }));
		System.out.println("Test Case 1 : " + maxProfit(new int[] { 1, 2, 3, 4, 5 }));
		System.out.println("Test Case 1 : " + maxProfit(new int[] { 5, 4, 3, 2, 1 }));
	}
