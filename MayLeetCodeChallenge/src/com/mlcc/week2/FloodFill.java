...
public class FloodFill {
	...
	public int[][] floodFill(int[][] image, int sr, int sc, int newColor) {
		...
		recApproachFill(image, sr, sc, newColor, image[sr][sc]);
		return image;
	}
	 ...
	 * Recursive Approach.
	 */
	public static void recApproachFill(int[][] image, int sr, int sc, int newColor, int color) {
		...
		recApproachFill(image, sr - 1, sc, newColor, color);
		recApproachFill(image, sr, sc - 1, newColor, color);
		recApproachFill(image, sr, sc + 1, newColor, color);
		recApproachFill(image, sr + 1, sc, newColor, color);
